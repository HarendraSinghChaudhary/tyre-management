...
class Tyre {
  ...
  factory Tyre.fromJson(Map<String, dynamic> json) => Tyre(
    id: json["id"],
    tyreStoreId: json["tyre_store_id"].toString() == "null" ? "null" : json["tyre_store_id"].toString(),
    ...
    tyreWarrantyExpireDate: DateTime.parse(json["tyre_warranty_expire_date"].toString()),
    ...
    tyreDismountReasion: json["tyre_dismount_reasion"].toString() == "null" ? "null" : json["tyre_dismount_reasion"].toString(),
