...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  TextEditingController confimrPasswordController = TextEditingController();
        ...
        Container(
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Text("To Login \n Continue with",textAlign: TextAlign.center,style: getStyle(fontSize: 20),),
  ...
  bool allFieldFilled() {
    if (emailController.value.text.isNotEmpty &&
        confimrPasswordController.text.isNotEmpty &&
  ...
  bool passwordMatching() {
    if (confimrPasswordController.text == passwordController.text &&
        passwordController.text.isNotEmpty &&
        passwordController.text.length >= 6) {
      return true;
    }
    if (confimrPasswordController.text.length < 6) {
      show("Password", "Password too short");
      return false;
    }
    Get.showSnackbar(GetSnackBar(
      backgroundColor: greenText,
      ...
      message: "Password and Confrim Passsword should be same",
    ));
    return false;
  }
