...
class LoadingPoint extends StatefulWidget {
  LoadingPoint({Key? key}) : super(key: key);

  @override
  State<LoadingPoint> createState() => _LoadingPointState();
}

class _LoadingPointState extends State<LoadingPoint> {
                        ...
                        Container(
                          ...
                          child: Obx(
                            () => DropdownSelection<Commodity>(
                              ...
                              maxHeight: ScreenSize.height * 0.3,
                              items: tripController.companyCommodity
                                  .map((element) => element)
                                  .toList(),
                              showClearButton: false,
                              onChanged: (item) {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                                child: Text(
                              file?.value == null ? "Attach Delivery Note" : "Image Attached",
                              maxLines: 1,
                  ...
                  Container(
                      ...
                      () =>  AbsorbPointer(
                          ...
                          child: DatePicker(
                              disabled: false,
                              bodyText:
                                  "Please confirm depart time from  ${cityName}",
                              buttonText: "Confirm",
