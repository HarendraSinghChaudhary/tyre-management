...
class InspectionSelectTyre extends StatefulWidget {
  const InspectionSelectTyre({Key? key}) : super(key: key);

  @override
  _InspectionSelectTyreState createState() => _InspectionSelectTyreState();
}

class _InspectionSelectTyreState extends State<InspectionSelectTyre> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final GlobalKey<RawGestureDetectorState> firstTyreKey =
      GlobalKey<RawGestureDetectorState>();

  /*late bool isFrontLeft;
  late bool isFrontRight;*/
